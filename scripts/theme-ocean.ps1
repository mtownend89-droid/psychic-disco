...
# pop-out panel: a 9-slice rounded frame (dark fill + aqua border). Used with border-image-slice ... fill, so the border
# thickness + corner radius stay CONSTANT at any modal size (the old stretched stroke ballooned into a fat tube).
$panel="<svg xmlns='http://www.w3.org/2000/svg' width='80' height='80' viewBox='0 0 80 80'>$defs<rect x='3' y='3' width='74' height='74' rx='20' fill='#0e3040' stroke='#3fb6d0' stroke-width='4'/><rect x='8' y='8' width='64' height='64' rx='15' fill='none' stroke='#7fe6ff' stroke-width='1.2' opacity='.5'/></svg>"
